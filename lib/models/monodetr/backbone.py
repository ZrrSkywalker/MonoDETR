...
class BackboneBase(nn.Module):
    ...
    def __init__(self, backbone: nn.Module, train_backbone: bool, return_interm_layers: bool, model_name: str = 'resnet50'):
        super().__init__()
        ...
        if return_interm_layers:
            ...
            if model_name == 'resnet18':
                ...
                raise NotImplementedError(f"backbone {model_name}")
        else:
